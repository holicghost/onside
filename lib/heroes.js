export const HEROES = {
  tank: [
    { id: 'domina', name: 'Domina', cfKey: 'domina' },
  ...
  damage: [
    { id: 'anran', name: 'Anran', cfKey: 'anran' },
    ...
    { id: 'emre', name: 'Emre', cfKey: 'emre' },
    { id: 'freja', name: 'Freja', cfKey: 'freja' },
    ...
    { id: 'sierra', name: 'Sierra', cfKey: 'sierra' },
    ...
    { id: 'vendetta', name: 'Vendetta', cfKey: 'vendetta' },
  ...
  support: [
    ...
    { id: 'mizuki', name: 'Mizuki', cfKey: 'mizuki' },
    { id: 'moira', name: 'Moira', cfKey: 'moira' },
    { id: 'wuyang', name: 'Wuyang', cfKey: 'wuyang' },
